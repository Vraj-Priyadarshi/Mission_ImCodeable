...
import { FolderGit2, Github, ExternalLink, Zap } from 'lucide-react';
      ...
      {projects && projects.length > 0 ? (
        <div className="space-y-4">
          {projects.slice(0, 5).map((project, index) => {
            ...
            const projectDescription = typeof project === 'string' ? null : project.description;
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    ...
                    {projectDescription && (
                      <p className="text-sm text-gray-400 mt-2 line-clamp-2">{projectDescription}</p>
                    )}
                  </div>
                </div>
                ...
                {projectSkills && projectSkills.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mt-3">
                    {projectSkills.slice(0, 4).map((skill, skillIndex) => (
                      <span
                        key={skillIndex}
