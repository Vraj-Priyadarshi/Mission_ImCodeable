...
export default function SkillGapCard({ skillGapScore = 0, recommendedSkills = [], sectorTheme }) {
  // Invert score for "gap" display (100 - score = gap percentage)
  const gapPercentage = Math.max(0, 100 - skillGapScore);
  const matchPercentage = skillGapScore;
    ...
    >
      ...
      <div className="mb-6">
        <div className="flex justify-between text-sm mb-2">
          ...
          <span className="text-gray-400">{gapPercentage}% gap to close</span>
        </div>
