...
public class Constants {
    ...
    public static final String VERIFICATION_EMAIL_SUBJECT = "Verify Your Email - Secure Starter";
    public static final String PASSWORD_RESET_EMAIL_SUBJECT = "Reset Your Password - Secure Starter";
